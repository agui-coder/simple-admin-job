...
import (
	...
	"github.com/suyuan32/simple-admin-job/internal/mqs/amq/handler/amq/pay"
...
func (m *MQTask) Register() {
	...
	mux.Handle(pattern.PayOrderSuccessNotify, pay.NewDemoOrderSuccessNotifyHandler(m.svcCtx))
	mux.Handle(pattern.PayRefundSuccessNotify, pay.NewDemoRefundSuccessNotifyHandler(m.svcCtx))
	m.mux = mux
}
